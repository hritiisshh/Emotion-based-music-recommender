...
@st.cache_resource
def load_models():
    face_model = tf.keras.models.load_model('C:\\Users\\ragipani sai ramana\\song\\face_emotion_recognition_model1.h5')
    audio_model = tf.keras.models.load_model('C:\\Users\\ragipani sai ramana\\song\\Emotion_Voice_Detection_Model1.h5')
...
def recommend_songs(emotion):
    ...
    try:
        df = pd.read_csv("C:\\Users\\ragipani sai ramana\\song\\songs.csv")
